...
public extension XSD {
	...
	class durationLexicalRep: XSD.Literal {
		...
		private static var pattern = #"-?P((([0-9]+Y([0-9]+M)?([0-9]+D)?|([0-9]+M)([0-9]+D)?|([0-9]+D))(T(([0-9]+H)([0-9]+M)?(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S)?|([0-9]+M)(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S)?|(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S)))?)|(T(([0-9]+H)([0-9]+M)?(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S)?|([0-9]+M)(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S)?|(([0-9]+|[0-9]+\.[0-9]*|\.[0-9]+)S))))"#

...
final class XSDTestLexicalSpaces: XCTestCase {
	...
	func testDurationLexicalRep() {
		...
		XCTAssertNotNil(XSD.durationLexicalRep("+.00E00"))
		XCTAssertNotNil(XSD.durationLexicalRep("-00.00e00"))
		XCTAssertNotNil(XSD.durationLexicalRep("+INF"))
		XCTAssertNotNil(XSD.durationLexicalRep("NaN"))
